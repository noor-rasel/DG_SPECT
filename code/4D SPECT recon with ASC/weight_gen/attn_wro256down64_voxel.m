...
for g=1:G
    ...
    for n=1:64
        if n<33
            wp_attnwgt((n-1)*64+1:n*64)=attnmat_voxel(x,n,wp_vray((n-1)*64+1:n*64),...
            ...
            m=n-32;
            wp_attnwgt((n-1)*64+1:n*64)=attnmat_voxel(x,n,wp_vray((m-1)*64+1:m*64),...
    ...
    tic,filename=['G:\imagereconstruction\4D\weights_gen\weight64_attn' num2str(g) '.mat'];
...
%old: weight64_attn1_old.mat (only 64 grids in SIMIND)