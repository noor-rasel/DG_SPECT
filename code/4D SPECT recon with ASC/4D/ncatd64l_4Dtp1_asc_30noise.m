...
if s==1%spatial only, no AC and SC:
    ...
    for tt=1%1:3
        for n=1:5
            ...
            filename=['./data_d64l_5st1/Im_ncatd64l_nAS_s' num2str(n) 't' num2str(tt) '_n' num2str(k) '.mat'];
...
elseif s==2%spatial only, AC, no SC:
    ...
    for tt=2%1:3
        for n=1:5
            ...
            filename=['./data_d64l_5st2/Im_ncatd64l_A_s' num2str(n) 't' num2str(tt) '_n' num2str(k) '.mat'];
...
elseif s==3%spatial only, AC and SC:
    ...
    for tt=2%1:3
        for n=1:5
            ...
            filename=['./data_d64l_5st2/Im_ncatd64l_AS_s' num2str(n) 't' num2str(tt) '_n' num2str(k) '.mat'];
