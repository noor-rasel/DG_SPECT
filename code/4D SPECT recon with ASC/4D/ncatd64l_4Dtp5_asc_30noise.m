function ncatd64l_4Dtp5_asc_30noise(com_numb)
...
elseif s==2%spatial only, AC, no SC:
    gbeta=[5e-4 1e-3 2e-3 3e-3 4e-3];%[0.0001:0.0002:0.002];%0.001
    ...
    for tt=5%1:3
        for n=1:5
            ...
            filename=['./data_d64l_5st5/Im_ncatd64l_A_s' num2str(n) 't' num2str(tt) '_n' num2str(k) '.mat'];
...
elseif s==3%spatial only, AC and SC:
    ...
    gbeta=[1e-3 2e-3 3e-3 4e-3 5e-3];%[0.001:0.0002:0.0028];%0.002
    ...
    for tt=5%1:3
        for n=1:5
            ...
            filename=['./data_d64l_5st5/Im_ncatd64l_AS_s' num2str(n) 't' num2str(tt) '_n' num2str(k) '.mat'];
