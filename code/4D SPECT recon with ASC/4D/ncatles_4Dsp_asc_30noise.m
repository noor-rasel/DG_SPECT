function ncatles_4Dsp_asc_30noise(com_numb)
...
if s==1%spatial only, no AC and SC:     
    ...
    for n=1:5
        ...
        filename=['Im_ncatles_nAS_s' num2str(n) 't0_n' num2str(k) '.mat'];
...
elseif s==2%spatial only, AC, no SC: 
    ...
    for n=1:5
        ...
        filename=['Im_ncatles_A_s' num2str(n) 't0_n' num2str(k) '.mat'];
...
elseif s==3%spatial only, AC and SC:
    ...
    for n=1:5
        ...
        filename=['Im_ncatles_AS_s' num2str(n) 't0_n' num2str(k) '.mat'];
