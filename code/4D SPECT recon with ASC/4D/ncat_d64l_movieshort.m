...
cview='short';p_slice=18; %cut to 20*20 for short axis images.
for n=1:G
    temp=Im_part(:,:,:,n);
...
noise_num=1;
filename={['C:\imagereconstruction\4D\data_d64l_fbp\Im_fbp_n' num2str(noise_num) '.mat'];...
    ['C:\imagereconstruction\4D\data_d64l_5st0\Im_d64l_nAS_s3t0_n' num2str(noise_num) '.mat'];...
    ['C:\imagereconstruction\4D\data_d64l_5st0\Im_d64l_A_s6t0_n' num2str(noise_num) '.mat'];...
    ['C:\imagereconstruction\4D\data_d64l_5st0\Im_d64l_AS.2LPF_s6t0_n' num2str(noise_num) '.mat'];...
    ['C:\imagereconstruction\4D\data_d64l_5st2\Im_ncatd64l_nAS_s1t2_n' num2str(noise_num) '.mat'];...
    ['C:\imagereconstruction\4D\data_d64l_5st5\Im_ncatd64l_A_s1t5_n' num2str(noise_num) '.mat'];...
    ['C:\imagereconstruction\4D\data_d64l_5st5\Im_ncatd64l_AS_s1t5_n' num2str(noise_num) '.mat']};
for k=1:7
    load(filename{k})
    if k>1
        Im_part=Im_maps(:,:,:,:);
...
save(['data_movied64l_' cview],'Im_combs');
G=16
for g=1:16 
...
%     end
% end
% save data_4Dmovienor_clincal Im_combs
% 
% G=16
% for g=1:16 
% interp_im(:,:,g)=interp2(Im_combs(:,:,g),2);
...
% end
% figure('position',[100 100 800 400]),movie(im,10)
% movie2avi(im,'4Dmovienor_clinical')
