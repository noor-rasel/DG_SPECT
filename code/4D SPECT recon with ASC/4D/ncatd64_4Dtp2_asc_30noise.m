function ncatd64_4Dtp2_asc_30noise(com_numb)
...
if s==1%spatial only, no AC and SC:
    ...
    for tt=1%1:3
        for n=1:5
            ...
            filename=['./data_d64_5st2/Im_ncatd64_nAS_s' num2str(n) 't' num2str(tt) '_n' num2str(k) '.mat'];
            save(filename,'Im_maps','snr_t');
        end
    end
elseif s==2%spatial only, AC, no SC:
    gbeta=[5e-4 1e-3 2e-3 3e-3 4e-3 6e-3];%[0.0001:0.0002:0.002];%0.001
    ...
    for tt=4%1:3
        for n=1:5
            ...
            filename=['./data_d64_5st2/Im_ncatd64_A_s' num2str(n) 't' num2str(tt) '_n' num2str(k) '.mat'];
...
elseif s==3%spatial only, AC and SC:
    ...
    gbeta=[1e-3 2e-3 3e-3 4e-3 5e-3 7e-3];%[0.001:0.0002:0.0028];%0.002
    ...
    for tt=4%1:3
        for n=1:5
            ...
            filename=['./data_d64_5st2/Im_ncatd64_AS_s' num2str(n) 't' num2str(tt) '_n' num2str(k) '.mat'];
