function [x,v_num,obj_func]=mbsrem4dv2(sino,x,sub,iter,of_tag,sbeta,gbeta,blur,attn,scat,motion_tag)
...
if attn==1
    load weight64_mn
    load weight64_attn1.mat   % load an average map weights or matched map
